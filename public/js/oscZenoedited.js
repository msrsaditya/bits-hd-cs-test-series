...
/*
fix as $.browser is deprecated now 
...
function checkIEVersionforScrachPad(){
...
$(document).ready(function () {
	...
	if(!checkIEVersion()||checkIEVersionforScrachPad()){
				$('#memory').addClass('importantRuleMemoryScientific');
				 $('#keyPad_btn0').attr('style', 'width: 76px;');
				 $('.degree_radian').attr('style', 'width: 80px;');
			}	
